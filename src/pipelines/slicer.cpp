...
// TRL 04/10/23: Implemented catalytic S gate injection stream
...
namespace lsqecc
{
    ...
    // TRL 04/04/23: Creating local instructions mode
            ...
            std::ostream& err_stream)
    {
        ...
        parser.add_argument()
                ...
                .required(false);
        // TRL 04/04/23: Local instructions are a command line argument
        parser.add_argument()
                .names({"--local"})
        ...
        // TRL 04/04/23: Implementing compilation mode (future should make mutually exclusive with PauliCorrections flag)
        ...
        if (parser.exists("layoutgenerator"))
        {
            ...
            else if (parser.get<std::string>("layoutgenerator") == "edpc") 
            {
                ...
                // TRL 04/10/23: Implemented catalytic S gate injection stream. Currently REQUIRES a pre-set bank of available Y states.
