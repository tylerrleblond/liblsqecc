...
BusyRegion (1,3),(2,3),StepsToClear(1);
BusyRegion (1,3),(2,3),StepsToClear(0);Init 100 |+>;MultiBodyMeasure 0:X,4:X;MultiBodyMeasure 2:Z,3:Z;RotateSingleCellPatch 100;
